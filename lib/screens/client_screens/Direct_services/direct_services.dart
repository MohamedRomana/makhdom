...
import 'package:makhdom/screens/client_screens/direcit_service_details/direct_service_details.dart';
...
class DirectServices extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: const SortsFloating(),
      body: Padding(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            return InkWell(
              onTap: () {
                AppRouter.navigateTo(context, const DirectServiceDetails());
              },
